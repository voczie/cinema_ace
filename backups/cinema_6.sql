...
8	Sexta-Feira 13	1980-05-09	Estados Unidos	01:35:00	Sean S. Cunningham	18
666	Ichi, o Assassino	2001-12-22	Japao	02:09:00	Takashi Miike	+18
\.
...
1	666	1	2023-10-01 13:55:00	Japones	t
2	666	1	2023-10-01 03:00:00	Japones	f
\.
...
ALTER TABLE ONLY public.generos_filmes
    ADD CONSTRAINT generos_filmes_genero_id_fkey FOREIGN KEY (genero_id) REFERENCES public.generos(id) ON UPDATE CASCADE ON DELETE CASCADE;
